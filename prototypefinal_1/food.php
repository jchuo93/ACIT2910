		  ...
		  <nav class="navbar navbar-default navbar-fixed-top">
			<div class="container-fluid">
			  <div class="navbar-header">
				...
				<a class="navbar-brand" href="prototype.php">Hotel Chain Name</a>
			  </div>
			  <div id="navbar" class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
				  <li><a href="prototype.php">Home</a></li>
...
<div id="content" class="text-center">
	<br/>
	<div class="alert alert-info"><h3>Click the arrow on the right to access the food listings of each category! &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon glyphicon-hand-down"></span></h3></div>
	...
	<h2>Breakfast</h2>
	  ...
	  <a class="right carousel-control" href="breakfast.html" role="button" data-slide="next">
...
<h2>Lunch</h2>
	  ...
	  <a class="right carousel-control" href="lunch.html" role="button" data-slide="next">
	    <span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span>
	    <span class="sr-only">Next</span>
     </a>
</div>
...
<h2>Dinner</h2>
	  ...
	  <a class="right carousel-control" href="dinner.html" role="button" data-slide="next">
	    <span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span>
	    <span class="sr-only">Next</span>
     </a>
</div>
