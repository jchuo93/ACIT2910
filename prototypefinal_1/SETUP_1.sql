...
insert into room (room_id, password) values ('101', '4br7$3');
insert into room (room_id, password) values ('294', 'j4Gt2#');
insert into room (room_id, password) values ('545', '*ER2-8');
...
insert into cart (room_id) values('101');
insert into cart (room_id) values('294');
insert into cart (room_id) values('545');
