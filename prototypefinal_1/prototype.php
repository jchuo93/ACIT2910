	...
	<div id="container" >
			...
			<div class="container-fluid">
			  ...
			  <div id="navbar" class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
				  <li class="active"><a href="prototype.php">Home</a></li>
                  <li><a href="#">Promotions</a></li>
                  <li><a href="#">Local Events</a></li>
                  <?php 

                  if(!empty($_SESSION['msg']) && $_SESSION['msg']=="Login Successful.") {
		...
		<div id="content" class="text-center">
				<?php 
					...
					if($_SESSION['msg']=="Login Successful."){
						echo "<br/><div class='alert alert-success'>" .$_SESSION['msg'] . "</div>";
					}
					else{
						echo "<br/><div class='alert alert-warning'>" .$_SESSION['msg'] . "</div>";
					}
				}
			  ...
			  <div class="jumbotron">
				...
				if(empty($_SESSION['roomid']) || empty($_SESSION['msg'])) {
