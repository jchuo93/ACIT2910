	...
	<div id="container" >
		  ...
		  <nav class="navbar navbar-default navbar-fixed-top">
			<div class="container-fluid">
			  <div class="navbar-header">
				...
				<a class="navbar-brand" href="loggedin.php">Hotel Chain Name</a>
			  </div>
			  <div id="navbar" class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
                  ...
                  <li><a href="prototype.php">Log out</a></li>
				</ul>
                <?php
                    echo "Hello, Room " . $_SESSION["roomid"];
                ?>
			  </div><!--/.nav-collapse -->
			</div><!--/.container-fluid -->
		  </nav>
		...
		<div id="content" class="text-center">
			...
			<div id="services" class="col-lg-6 jumbotron">
				...
				<a class="btn btn-md btn-success" href="products.php" role="button">Order Now</a>
			</div>
			...
			<div id="food" class="col-lg-6 jumbotron">
				...
				<a class="btn btn-md btn-success" href="food.php" role="button">Order Now</a>
			</div>
