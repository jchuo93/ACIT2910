...
class Messages {
    ...
    public static function getMessagesAsJSONArray() {
        $data = array();
        foreach(self::$messageList as $msg) {
            //array_push($data, array($msg->type => $msg->text));
            array_push($data, $msg->type . ": " . $msg->text);
        }
        return json_encode($data);
        //return self::$messageList;
    }

    public static function getAllMessagesasHTMLList() {
        $html = "<ul>";
        foreach(self::$messageList as $msg) {
